                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">{/*Modal body*/}
                            <p className='fs-6 fw-lighter text-body-secondary mt-1 mb-1'>Task: {children.modalItems.name}</p>
                            <ul className={"list-group list-group-flush"}>
                                ...
                                <li className={"list-group-item "+Style.doneItems} data-bs-dismiss="modal" onClick={()=>children.removeGroceryItem(children.modalItems.id, children.modalItems.name)}>
